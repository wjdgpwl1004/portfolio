...
$(document).ready(function() {
	...
	// $(window).resize(function(){
	// 	if(!$(".notice_zone .tab_btn").is(":hidden")){
	// 		dateTapAC();
	// 	}
	// });
});
...
$(document).ready(function() {
	...
	window.banners = $('.profes_intro .js_slide>.move>.mo_type>li');
	

	if($(".profes_intro .js_slide").size() != 0){
		js_banner_size2($(".profes_intro .js_slide"));
	}
	$(window).resize(function(){
		js_banner_size2($(".profes_intro .js_slide"));
	});
...
function js_banner_size2(obj){
	...
	if(win_wid > 1024){
		...
		obj.move.ul.find('>li').width((parseInt(obj.move.width()/1)-1)+"px");			
	}
